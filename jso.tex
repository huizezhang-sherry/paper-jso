...
<<<<<<< HEAD
\begin{tcolorbox}[enhanced jigsaw, leftrule=.75mm, title={Algorithm: Jellyfish Optimizer Pseudo Code}, colback=white, bottomrule=.15mm, arc=.35mm, breakable, colbacktitle=quarto-callout-note-color!10!white, rightrule=.15mm, bottomtitle=1mm, toptitle=1mm, colframe=quarto-callout-note-color-frame, toprule=.15mm, coltitle=black, opacitybacktitle=0.6, left=2mm, opacityback=0, titlerule=0mm]
=======
\begin{tcolorbox}[enhanced jigsaw, coltitle=black, breakable, colback=white, colframe=quarto-callout-note-color-frame, rightrule=.15mm, arc=.35mm, bottomtitle=1mm, colbacktitle=quarto-callout-note-color!10!white, leftrule=.75mm, left=2mm, bottomrule=.15mm, opacitybacktitle=0.6, toprule=.15mm, toptitle=1mm, titlerule=0mm, title={Algorithm: Jellyfish Optimizer Pseudo Code}, opacityback=0]
>>>>>>> 6330782700a93d4206753837532aa238991d5a00
