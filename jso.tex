...
\begin{tcolorbox}[enhanced jigsaw, rightrule=.15mm, opacitybacktitle=0.6, toprule=.15mm, colback=white, opacityback=0, left=2mm, bottomtitle=1mm, breakable, arc=.35mm, bottomrule=.15mm, titlerule=0mm, leftrule=.75mm, toptitle=1mm, colframe=quarto-callout-note-color-frame, colbacktitle=quarto-callout-note-color!10!white, title={Algorithm: Jellyfish Optimizer Pseudo Code}, coltitle=black]
