...
\begin{tcolorbox}[enhanced jigsaw, title={Algorithm: Jellyfish Optimizer Pseudo Code}, colbacktitle=quarto-callout-note-color!10!white, left=2mm, titlerule=0mm, rightrule=.15mm, opacityback=0, bottomrule=.15mm, leftrule=.75mm, colback=white, colframe=quarto-callout-note-color-frame, bottomtitle=1mm, toptitle=1mm, arc=.35mm, opacitybacktitle=0.6, breakable, toprule=.15mm, coltitle=black]
