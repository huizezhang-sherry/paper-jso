...
\begin{tcolorbox}[enhanced jigsaw, rightrule=.15mm, colback=white, title={Algorithm: Jellyfish Optimizer Pseudo Code}, colframe=quarto-callout-note-color-frame, toprule=.15mm, arc=.35mm, opacityback=0, opacitybacktitle=0.6, bottomrule=.15mm, breakable, left=2mm, coltitle=black, bottomtitle=1mm, toptitle=1mm, colbacktitle=quarto-callout-note-color!10!white, leftrule=.75mm, titlerule=0mm]
