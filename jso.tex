...
\begin{tcolorbox}[enhanced jigsaw, arc=.35mm, toptitle=1mm, colframe=quarto-callout-note-color-frame, colback=white, bottomrule=.15mm, opacitybacktitle=0.6, coltitle=black, toprule=.15mm, title={Algorithm: Jellyfish Optimizer Pseudo Code}, bottomtitle=1mm, colbacktitle=quarto-callout-note-color!10!white, titlerule=0mm, breakable, rightrule=.15mm, left=2mm, opacityback=0, leftrule=.75mm]
...
\pandocbounded{\includegraphics[keepaspectratio]{jso_files/figure-pdf/fig-plot-data-1.pdf}}
...
in squintability of one unit increases the success rate by 124\%. As
dimension increases by one the success rate halves. Increasing the
number of jellies by 10, increases the succes rate by 6\%.
