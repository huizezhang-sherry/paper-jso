...
\begin{tcolorbox}[enhanced jigsaw, breakable, opacitybacktitle=0.6, colframe=quarto-callout-note-color-frame, opacityback=0, arc=.35mm, toptitle=1mm, leftrule=.75mm, colbacktitle=quarto-callout-note-color!10!white, bottomtitle=1mm, left=2mm, titlerule=0mm, title={Algorithm: Jellyfish Optimizer Pseudo Code}, toprule=.15mm, coltitle=black, rightrule=.15mm, bottomrule=.15mm, colback=white]
