...
\begin{tcolorbox}[enhanced jigsaw, colframe=quarto-callout-note-color-frame, bottomrule=.15mm, title={Algorithm: Jellyfish Optimizer Pseudo Code}, opacityback=0, breakable, opacitybacktitle=0.6, rightrule=.15mm, left=2mm, toprule=.15mm, titlerule=0mm, toptitle=1mm, bottomtitle=1mm, arc=.35mm, leftrule=.75mm, coltitle=black, colbacktitle=quarto-callout-note-color!10!white, colback=white]
