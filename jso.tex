...
\begin{tcolorbox}[enhanced jigsaw, bottomtitle=1mm, colbacktitle=quarto-callout-note-color!10!white, title={Algorithm: Jellyfish Optimizer Pseudo Code}, arc=.35mm, breakable, colback=white, opacityback=0, leftrule=.75mm, toprule=.15mm, rightrule=.15mm, toptitle=1mm, colframe=quarto-callout-note-color-frame, titlerule=0mm, coltitle=black, bottomrule=.15mm, left=2mm, opacitybacktitle=0.6]
