...
\begin{tcolorbox}[enhanced jigsaw, opacitybacktitle=0.6, opacityback=0, colframe=quarto-callout-note-color-frame, leftrule=.75mm, toprule=.15mm, arc=.35mm, toptitle=1mm, bottomtitle=1mm, title={Algorithm: Jellyfish Optimizer Pseudo Code}, left=2mm, breakable, colback=white, titlerule=0mm, rightrule=.15mm, bottomrule=.15mm, coltitle=black, colbacktitle=quarto-callout-note-color!10!white]
