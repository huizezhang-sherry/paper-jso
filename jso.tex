...
\begin{tcolorbox}[enhanced jigsaw, opacityback=0, toprule=.15mm, colframe=quarto-callout-note-color-frame, breakable, toptitle=1mm, title={Algorithm: Jellyfish Optimizer Pseudo Code}, coltitle=black, leftrule=.75mm, colbacktitle=quarto-callout-note-color!10!white, colback=white, opacitybacktitle=0.6, bottomrule=.15mm, titlerule=0mm, rightrule=.15mm, arc=.35mm, bottomtitle=1mm, left=2mm]
