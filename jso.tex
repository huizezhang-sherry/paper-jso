...
\begin{tcolorbox}[enhanced jigsaw, arc=.35mm, breakable, toprule=.15mm, left=2mm, title={Algorithm: Jellyfish Optimizer Pseudo Code}, titlerule=0mm, bottomrule=.15mm, colbacktitle=quarto-callout-note-color!10!white, leftrule=.75mm, opacitybacktitle=0.6, colframe=quarto-callout-note-color-frame, colback=white, bottomtitle=1mm, opacityback=0, rightrule=.15mm, toptitle=1mm, coltitle=black]
