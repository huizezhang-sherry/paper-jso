...
\begin{tcolorbox}[enhanced jigsaw, bottomrule=.15mm, arc=.35mm, colbacktitle=quarto-callout-note-color!10!white, titlerule=0mm, opacitybacktitle=0.6, left=2mm, colframe=quarto-callout-note-color-frame, breakable, toprule=.15mm, opacityback=0, coltitle=black, title={Algorithm: Jellyfish Optimizer Pseudo Code}, bottomtitle=1mm, rightrule=.15mm, colback=white, toptitle=1mm, leftrule=.75mm]
