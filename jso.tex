...
\begin{tcolorbox}[enhanced jigsaw, opacitybacktitle=0.6, colframe=quarto-callout-note-color-frame, toptitle=1mm, opacityback=0, coltitle=black, titlerule=0mm, bottomtitle=1mm, colbacktitle=quarto-callout-note-color!10!white, leftrule=.75mm, breakable, title={Algorithm: Jellyfish Optimizer Pseudo Code}, arc=.35mm, rightrule=.15mm, bottomrule=.15mm, toprule=.15mm, left=2mm, colback=white]
...
Squintability & 1.23 (1.12 to 1.38) & \textbf{<0.001} \\ 
Dimension & 0.58 (0.45 to 0.73) & \textbf{<0.001} \\ 
