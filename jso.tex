...
\begin{tcolorbox}[enhanced jigsaw, toprule=.15mm, bottomrule=.15mm, title={Algorithm: Jellyfish Optimizer Pseudo Code}, breakable, toptitle=1mm, colframe=quarto-callout-note-color-frame, titlerule=0mm, opacityback=0, opacitybacktitle=0.6, coltitle=black, leftrule=.75mm, colback=white, arc=.35mm, bottomtitle=1mm, rightrule=.15mm, colbacktitle=quarto-callout-note-color!10!white, left=2mm]
