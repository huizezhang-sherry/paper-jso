...
package (H. Wickham et al. 2011) in R (R Core Team 2023). Zhang et al.
...
\begin{tcolorbox}[enhanced jigsaw, colback=white, colbacktitle=quarto-callout-note-color!10!white, opacitybacktitle=0.6, opacityback=0, bottomtitle=1mm, leftrule=.75mm, breakable, arc=.35mm, colframe=quarto-callout-note-color-frame, title={Algorithm: Jellyfish Optimizer Pseudo Code}, coltitle=black, titlerule=0mm, toptitle=1mm, rightrule=.15mm, left=2mm, toprule=.15mm, bottomrule=.15mm]
...
pipe & holes & 12 & 0.02 & 0.43 & 2.72 & 0.00 & 1.01 & 0.88 & 3.34 & 0.00 & 0.41\\
...
The R packages used in this work include: \texttt{tidyverse} (Hadley
Wickham et al. 2019); \texttt{patchwork} (Pedersen 2024); \texttt{ggh4x}
(van den Brand 2024); \texttt{broom} (Robinson, Hayes, and Couch 2024);
\texttt{kableExtra} (Zhu 2024); \texttt{ferrn} (Zhang et al. 2021); and
\texttt{cassowaryr} (Mason et al. 2022).
...
Mason, Harriet, Stuart Lee, Ursula Laa, and Dianne Cook. 2022.
\emph{Cassowaryr: Compute Scagnostics on Pairs of Numeric Variables in a
Data Set}. \url{https://CRAN.R-project.org/package=cassowayr}.
