...
\begin{tcolorbox}[enhanced jigsaw, titlerule=0mm, opacityback=0, left=2mm, colback=white, leftrule=.75mm, toprule=.15mm, colbacktitle=quarto-callout-note-color!10!white, title={Algorithm: Jellyfish Optimizer Pseudo Code}, bottomtitle=1mm, breakable, rightrule=.15mm, arc=.35mm, toptitle=1mm, bottomrule=.15mm, opacitybacktitle=0.6, colframe=quarto-callout-note-color-frame, coltitle=black]
