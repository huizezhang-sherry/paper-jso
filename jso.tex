...
\begin{tcolorbox}[enhanced jigsaw, colbacktitle=quarto-callout-note-color!10!white, opacityback=0, title={Algorithm: Jellyfish Optimizer Pseudo Code}, breakable, bottomtitle=1mm, leftrule=.75mm, titlerule=0mm, toprule=.15mm, left=2mm, colback=white, bottomrule=.15mm, colframe=quarto-callout-note-color-frame, arc=.35mm, coltitle=black, toptitle=1mm, rightrule=.15mm, opacitybacktitle=0.6]
