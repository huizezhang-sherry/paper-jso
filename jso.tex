...
\begin{tcolorbox}[enhanced jigsaw, opacitybacktitle=0.6, colback=white, bottomtitle=1mm, breakable, colframe=quarto-callout-note-color-frame, left=2mm, toptitle=1mm, arc=.35mm, opacityback=0, leftrule=.75mm, rightrule=.15mm, titlerule=0mm, title={Algorithm: Jellyfish Optimizer Pseudo Code}, bottomrule=.15mm, coltitle=black, toprule=.15mm, colbacktitle=quarto-callout-note-color!10!white]
