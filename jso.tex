...
\end{keywords}
\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[frame hidden, breakable, boxrule=0pt, sharp corners, enhanced, interior hidden, borderline west={3pt}{0pt}{shadecolor}]}{\end{tcolorbox}}\fi
...
\begin{tcolorbox}[enhanced jigsaw, rightrule=.15mm, bottomrule=.15mm, colbacktitle=quarto-callout-note-color!10!white, opacityback=0, colframe=quarto-callout-note-color-frame, colback=white, toptitle=1mm, breakable, coltitle=black, opacitybacktitle=0.6, arc=.35mm, toprule=.15mm, left=2mm, bottomtitle=1mm, leftrule=.75mm, titlerule=0mm, title={Algorithm: Jellyfish Optimizer Pseudo Code}]
