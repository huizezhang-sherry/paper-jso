...
\begin{tcolorbox}[enhanced jigsaw, breakable, colbacktitle=quarto-callout-note-color!10!white, opacityback=0, leftrule=.75mm, colframe=quarto-callout-note-color-frame, title={Algorithm: Jellyfish Optimizer Pseudo Code}, rightrule=.15mm, coltitle=black, colback=white, bottomrule=.15mm, bottomtitle=1mm, toptitle=1mm, left=2mm, titlerule=0mm, arc=.35mm, toprule=.15mm, opacitybacktitle=0.6]
