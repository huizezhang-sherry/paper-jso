...
\begin{tcolorbox}[enhanced jigsaw, rightrule=.15mm, opacitybacktitle=0.6, arc=.35mm, colback=white, title={Algorithm: Jellyfish Optimizer Pseudo Code}, titlerule=0mm, coltitle=black, bottomrule=.15mm, left=2mm, breakable, toprule=.15mm, colbacktitle=quarto-callout-note-color!10!white, toptitle=1mm, bottomtitle=1mm, opacityback=0, colframe=quarto-callout-note-color-frame, leftrule=.75mm]
...
Squintability & 7.85 (2.40 to 37.7) & \textbf{0.003} \\ 
Dimension & 0.53 (0.30 to 0.83) & \textbf{0.014} \\ 
Long runtime & 0.42 (0.03 to 5.44) & 0.497 \\ 
Number of jellyfish & 1.24 (0.98 to 1.63) & \textbf{0.089} \\ 
...
squintability, as explained in Section~\ref{sec-discussion}, and the
