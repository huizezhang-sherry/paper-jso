...
\end{keywords}
\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[breakable, interior hidden, boxrule=0pt, sharp corners, frame hidden, borderline west={3pt}{0pt}{shadecolor}, enhanced]}{\end{tcolorbox}}\fi
...
\begin{tcolorbox}[enhanced jigsaw, opacityback=0, left=2mm, bottomtitle=1mm, breakable, bottomrule=.15mm, titlerule=0mm, opacitybacktitle=0.6, toprule=.15mm, colback=white, toptitle=1mm, leftrule=.75mm, rightrule=.15mm, title={Algorithm: Jellyfish Optimizer Pseudo Code}, arc=.35mm, colframe=quarto-callout-note-color-frame, coltitle=black, colbacktitle=quarto-callout-note-color!10!white]
...
calculated for each random basis before fitting the Gaussian process
...
scaled logistic function (\ref{eq-parametric}) is fitted to the index
values against projection distances, estimated by non-linear least
squares. The squintability measure is then calculated as
(\ref{eq-squintability-parametric}).
...
run time over 20 seconds, and 3) re-coding the success rate for the
...
given the orthonormality contraint and calculate the index value
associated with each random basis, and 2) fit a Gaussian process model
of index values against projection distances to obtain the smoothness
measure.}
...
jellyfish and a maximum of 50 tries) can already achieve a high success
rate. However, larger parameter values (i.e.~100 jellyfish and a maximum
of 100 tries) are necessary for higher-dimensional problems (8, 10, and
12 dimensions). Increasing both parameters enhances the performance of
JSO, but it also extends the computational time required for the
...
\midrule
1 & pipe & holes & 6 & 0.03 & 0.39 & 3.08 & 0.0 & 1.02 & 0.86 & 3.37 & 0.02 & 3.05\\
2 & pipe & holes & 8 & 0.02 & 0.32 & 2.86 & 0.0 & 1.01 & 0.87 & 3.26 & 0.03 & 2.96\\
3 & pipe & holes & 10 & 0.02 & 0.36 & 2.80 & 0.0 & 1.02 & 0.88 & 3.15 & 0.02 & 2.95\\
4 & pipe & holes & 12 & 0.02 & 0.36 & 2.82 & 0.0 & 1.01 & 0.88 & 3.34 & 0.00 & 3.12\\
5 & sine & MIC & 6 & 0.06 & 0.29 & 3.15 & 0.0 & 0.89 & 0.57 & 1.62 & -0.02 & 1.26\\
6 & sine & MIC & 8 & 0.06 & 0.33 & 3.09 & 0.0 & 0.93 & 0.33 & 1.31 & -0.03 & 0.77\\
7 & sine & TIC & 6 & 0.17 & 0.34 & 3.06 & 0.0 & 0.95 & 0.54 & 1.72 & -0.03 & 1.32\\
8 & sine & TIC & 8 & 0.16 & 0.31 & 3.17 & 0.0 & 0.95 & 0.56 & 1.72 & -0.03 & 1.37\\
9 & sine & dcor & 6 & 0.09 & 0.31 & 3.06 & 0.0 & 0.95 & 1.04 & 2.74 & -0.02 & 2.95\\
10 & sine & loess & 6 & 0.24 & 0.45 & 3.53 & 0.0 & 1.02 & 1.04 & 2.65 & 0.08 & 2.76\\
11 & sine & splines & 6 & 0.10 & 0.32 & 3.11 & 0.0 & 1.01 & 1.05 & 2.73 & -0.01 & 3.12\\
12 & sine & stringy & 6 & 0.00 & 1128.28 & 1.03 & 134.8 & 1.05 & 0.01 & 254.73 & 0.05 & 2.96\\
\bottomrule
\end{tabular}
\endgroup{}
\end{table}
