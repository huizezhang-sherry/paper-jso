...
Langrené. Email: \href{mailto:nicolaslangrene@bnbu.edu.cn}{\nolinkurl{nicolaslangrene@bnbu.edu.cn}}. Jessica
Wai Yin
...
\begin{tcolorbox}[enhanced jigsaw, bottomtitle=1mm, toptitle=1mm, rightrule=.15mm, colback=white, coltitle=black, leftrule=.75mm, titlerule=0mm, opacitybacktitle=0.6, colbacktitle=quarto-callout-note-color!10!white, arc=.35mm, bottomrule=.15mm, opacityback=0, colframe=quarto-callout-note-color-frame, title={Algorithm: Jellyfish Optimizer Pseudo Code}, breakable, toprule=.15mm, left=2mm]
