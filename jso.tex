...
\begin{tcolorbox}[enhanced jigsaw, rightrule=.15mm, breakable, colframe=quarto-callout-note-color-frame, arc=.35mm, titlerule=0mm, left=2mm, bottomrule=.15mm, toprule=.15mm, coltitle=black, bottomtitle=1mm, opacitybacktitle=0.6, colback=white, toptitle=1mm, opacityback=0, title={Algorithm: Jellyfish Optimizer Pseudo Code}, leftrule=.75mm, colbacktitle=quarto-callout-note-color!10!white]
