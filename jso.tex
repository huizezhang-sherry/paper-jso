...
\begin{tcolorbox}[enhanced jigsaw, breakable, bottomrule=.15mm, colframe=quarto-callout-note-color-frame, toptitle=1mm, opacityback=0, opacitybacktitle=0.6, colback=white, titlerule=0mm, colbacktitle=quarto-callout-note-color!10!white, leftrule=.75mm, title={Algorithm: Jellyfish Optimizer Pseudo Code}, coltitle=black, arc=.35mm, toprule=.15mm, rightrule=.15mm, left=2mm, bottomtitle=1mm]
