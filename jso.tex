...
\begin{tcolorbox}[enhanced jigsaw, leftrule=.75mm, opacitybacktitle=0.6, breakable, coltitle=black, titlerule=0mm, bottomrule=.15mm, arc=.35mm, rightrule=.15mm, toprule=.15mm, colframe=quarto-callout-note-color-frame, colback=white, colbacktitle=quarto-callout-note-color!10!white, opacityback=0, title={Algorithm: Jellyfish Optimizer Pseudo Code}, bottomtitle=1mm, left=2mm, toptitle=1mm]
