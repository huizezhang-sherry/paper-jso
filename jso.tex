...
\begin{tcolorbox}[enhanced jigsaw, colframe=quarto-callout-note-color-frame, bottomtitle=1mm, breakable, rightrule=.15mm, toptitle=1mm, colbacktitle=quarto-callout-note-color!10!white, toprule=.15mm, arc=.35mm, coltitle=black, colback=white, opacityback=0, left=2mm, title={Algorithm: Jellyfish Optimizer Pseudo Code}, titlerule=0mm, bottomrule=.15mm, leftrule=.75mm, opacitybacktitle=0.6]
