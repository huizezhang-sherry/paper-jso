...
\begin{tcolorbox}[enhanced jigsaw, bottomrule=.15mm, left=2mm, rightrule=.15mm, opacityback=0, title={Algorithm: Jellyfish Optimizer Pseudo Code}, breakable, opacitybacktitle=0.6, colback=white, colframe=quarto-callout-note-color-frame, toprule=.15mm, toptitle=1mm, arc=.35mm, leftrule=.75mm, bottomtitle=1mm, titlerule=0mm, colbacktitle=quarto-callout-note-color!10!white, coltitle=black]
