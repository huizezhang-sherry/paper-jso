...
\begin{tcolorbox}[enhanced jigsaw, toprule=.15mm, coltitle=black, bottomrule=.15mm, titlerule=0mm, colbacktitle=quarto-callout-note-color!10!white, rightrule=.15mm, leftrule=.75mm, colframe=quarto-callout-note-color-frame, toptitle=1mm, breakable, title={Algorithm: Jellyfish Optimizer Pseudo Code}, left=2mm, opacitybacktitle=0.6, opacityback=0, bottomtitle=1mm, arc=.35mm, colback=white]
