...
\begin{tcolorbox}[enhanced jigsaw, bottomtitle=1mm, left=2mm, toprule=.15mm, opacityback=0, leftrule=.75mm, colbacktitle=quarto-callout-note-color!10!white, colframe=quarto-callout-note-color-frame, opacitybacktitle=0.6, bottomrule=.15mm, toptitle=1mm, breakable, title={Algorithm: Jellyfish Optimizer Pseudo Code}, colback=white, titlerule=0mm, coltitle=black, arc=.35mm, rightrule=.15mm]
