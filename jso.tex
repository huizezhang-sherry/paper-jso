...
\begin{tcolorbox}[enhanced jigsaw, breakable, bottomtitle=1mm, opacitybacktitle=0.6, toptitle=1mm, title={Algorithm: Jellyfish Optimizer Pseudo Code}, arc=.35mm, colbacktitle=quarto-callout-note-color!10!white, opacityback=0, toprule=.15mm, left=2mm, bottomrule=.15mm, rightrule=.15mm, titlerule=0mm, coltitle=black, leftrule=.75mm, colframe=quarto-callout-note-color-frame, colback=white]
