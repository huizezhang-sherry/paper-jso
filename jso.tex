...
\begin{tcolorbox}[enhanced jigsaw, colback=white, coltitle=black, breakable, opacityback=0, rightrule=.15mm, colframe=quarto-callout-note-color-frame, left=2mm, toprule=.15mm, toptitle=1mm, bottomtitle=1mm, arc=.35mm, opacitybacktitle=0.6, colbacktitle=quarto-callout-note-color!10!white, bottomrule=.15mm, titlerule=0mm, title={Algorithm: Jellyfish Optimizer Pseudo Code}, leftrule=.75mm]
