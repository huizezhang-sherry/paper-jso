...
\begin{tcolorbox}[enhanced jigsaw, leftrule=.75mm, opacitybacktitle=0.6, arc=.35mm, left=2mm, opacityback=0, colframe=quarto-callout-note-color-frame, rightrule=.15mm, colbacktitle=quarto-callout-note-color!10!white, breakable, bottomtitle=1mm, bottomrule=.15mm, toptitle=1mm, title={Algorithm: Jellyfish Optimizer Pseudo Code}, titlerule=0mm, toprule=.15mm, colback=white, coltitle=black]
...
A generalised linear model is fitted using a quasibinomial family and a
...
number of tries) on the success rate is summarised in
...
(sine wave). (Note index values were self-standardised to range between
