...
\begin{tcolorbox}[enhanced jigsaw, coltitle=black, rightrule=.15mm, colframe=quarto-callout-note-color-frame, left=2mm, colbacktitle=quarto-callout-note-color!10!white, leftrule=.75mm, breakable, opacitybacktitle=0.6, arc=.35mm, title={Algorithm: Jellyfish Optimizer Pseudo Code}, colback=white, opacityback=0, bottomtitle=1mm, titlerule=0mm, toptitle=1mm, bottomrule=.15mm, toprule=.15mm]
