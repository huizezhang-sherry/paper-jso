...
\begin{tcolorbox}[enhanced jigsaw, toptitle=1mm, bottomrule=.15mm, breakable, colbacktitle=quarto-callout-note-color!10!white, title={Algorithm: Jellyfish Optimizer Pseudo Code}, coltitle=black, colback=white, colframe=quarto-callout-note-color-frame, bottomtitle=1mm, titlerule=0mm, arc=.35mm, opacityback=0, leftrule=.75mm, toprule=.15mm, opacitybacktitle=0.6, rightrule=.15mm, left=2mm]
...
Definition \ref{def:squintability} is \ldots{}
