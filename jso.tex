...
\begin{tcolorbox}[enhanced jigsaw, toptitle=1mm, rightrule=.15mm, arc=.35mm, colback=white, opacitybacktitle=0.6, colbacktitle=quarto-callout-note-color!10!white, toprule=.15mm, leftrule=.75mm, breakable, bottomrule=.15mm, colframe=quarto-callout-note-color-frame, opacityback=0, left=2mm, titlerule=0mm, title={Algorithm: Jellyfish Optimizer Pseudo Code}, bottomtitle=1mm, coltitle=black]
