...
\begin{tcolorbox}[enhanced jigsaw, opacitybacktitle=0.6, toprule=.15mm, coltitle=black, colframe=quarto-callout-note-color-frame, breakable, colbacktitle=quarto-callout-note-color!10!white, titlerule=0mm, bottomtitle=1mm, toptitle=1mm, title={Algorithm: Jellyfish Optimizer Pseudo Code}, arc=.35mm, rightrule=.15mm, bottomrule=.15mm, left=2mm, leftrule=.75mm, opacityback=0, colback=white]
