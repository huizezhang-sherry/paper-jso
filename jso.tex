...
\begin{tcolorbox}[enhanced jigsaw, colbacktitle=quarto-callout-note-color!10!white, arc=.35mm, coltitle=black, opacitybacktitle=0.6, title={Algorithm: Jellyfish Optimizer Pseudo Code}, breakable, opacityback=0, toprule=.15mm, left=2mm, bottomtitle=1mm, rightrule=.15mm, bottomrule=.15mm, titlerule=0mm, colframe=quarto-callout-note-color-frame, colback=white, leftrule=.75mm, toptitle=1mm]
