...
\begin{tcolorbox}[enhanced jigsaw, colback=white, opacitybacktitle=0.6, arc=.35mm, colbacktitle=quarto-callout-note-color!10!white, toptitle=1mm, opacityback=0, breakable, bottomrule=.15mm, bottomtitle=1mm, titlerule=0mm, coltitle=black, colframe=quarto-callout-note-color-frame, title={Algorithm: Jellyfish Optimizer Pseudo Code}, rightrule=.15mm, toprule=.15mm, leftrule=.75mm, left=2mm]
