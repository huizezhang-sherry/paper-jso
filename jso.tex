...
\begin{tcolorbox}[enhanced jigsaw, toprule=.15mm, bottomtitle=1mm, opacityback=0, left=2mm, toptitle=1mm, opacitybacktitle=0.6, colframe=quarto-callout-note-color-frame, title={Algorithm: Jellyfish Optimizer Pseudo Code}, rightrule=.15mm, coltitle=black, titlerule=0mm, breakable, arc=.35mm, colback=white, bottomrule=.15mm, leftrule=.75mm, colbacktitle=quarto-callout-note-color!10!white]
