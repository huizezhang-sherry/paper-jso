...
\begin{tcolorbox}[enhanced jigsaw, colbacktitle=quarto-callout-note-color!10!white, bottomtitle=1mm, leftrule=.75mm, title={Algorithm: Jellyfish Optimizer Pseudo Code}, rightrule=.15mm, opacityback=0, breakable, coltitle=black, colframe=quarto-callout-note-color-frame, left=2mm, toprule=.15mm, bottomrule=.15mm, toptitle=1mm, titlerule=0mm, arc=.35mm, opacitybacktitle=0.6, colback=white]
