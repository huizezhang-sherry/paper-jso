...
\begin{tcolorbox}[enhanced jigsaw, bottomtitle=1mm, colbacktitle=quarto-callout-note-color!10!white, coltitle=black, colback=white, opacitybacktitle=0.6, left=2mm, titlerule=0mm, toprule=.15mm, arc=.35mm, title={Algorithm: Jellyfish Optimizer Pseudo Code}, leftrule=.75mm, colframe=quarto-callout-note-color-frame, opacityback=0, breakable, toptitle=1mm, rightrule=.15mm, bottomrule=.15mm]
...
data produced as described in Section 5 in can be found at
