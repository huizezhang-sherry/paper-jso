...
\begin{tcolorbox}[enhanced jigsaw, colback=white, opacitybacktitle=0.6, breakable, bottomrule=.15mm, titlerule=0mm, colbacktitle=quarto-callout-note-color!10!white, title={Algorithm: Jellyfish Optimizer Pseudo Code}, leftrule=.75mm, opacityback=0, bottomtitle=1mm, coltitle=black, colframe=quarto-callout-note-color-frame, toptitle=1mm, arc=.35mm, toprule=.15mm, rightrule=.15mm, left=2mm]
