...
\begin{tcolorbox}[enhanced jigsaw, colback=white, opacityback=0, coltitle=black, arc=.35mm, toprule=.15mm, leftrule=.75mm, colbacktitle=quarto-callout-note-color!10!white, breakable, colframe=quarto-callout-note-color-frame, opacitybacktitle=0.6, title={Algorithm: Jellyfish Optimizer Pseudo Code}, bottomtitle=1mm, bottomrule=.15mm, titlerule=0mm, rightrule=.15mm, toptitle=1mm, left=2mm]
