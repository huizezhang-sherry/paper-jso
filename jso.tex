...
\begin{tcolorbox}[enhanced jigsaw, title={Algorithm: Jellyfish Optimizer Pseudo Code}, toprule=.15mm, colbacktitle=quarto-callout-note-color!10!white, breakable, titlerule=0mm, colframe=quarto-callout-note-color-frame, coltitle=black, left=2mm, colback=white, leftrule=.75mm, arc=.35mm, bottomtitle=1mm, bottomrule=.15mm, opacityback=0, toptitle=1mm, rightrule=.15mm, opacitybacktitle=0.6]
...
hyper-parameters on optimization success, using the holes index for pipe
