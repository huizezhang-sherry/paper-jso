...
\begin{tcolorbox}[enhanced jigsaw, title={Algorithm: Jellyfish Optimizer Pseudo Code}, colframe=quarto-callout-note-color-frame, colbacktitle=quarto-callout-note-color!10!white, opacitybacktitle=0.6, arc=.35mm, colback=white, bottomtitle=1mm, opacityback=0, breakable, bottomrule=.15mm, rightrule=.15mm, left=2mm, toprule=.15mm, toptitle=1mm, titlerule=0mm, coltitle=black, leftrule=.75mm]
