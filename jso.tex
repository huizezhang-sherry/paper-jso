...
\begin{tcolorbox}[enhanced jigsaw, bottomrule=.15mm, rightrule=.15mm, left=2mm, colbacktitle=quarto-callout-note-color!10!white, colframe=quarto-callout-note-color-frame, leftrule=.75mm, toptitle=1mm, colback=white, titlerule=0mm, breakable, opacityback=0, opacitybacktitle=0.6, bottomtitle=1mm, toprule=.15mm, title={Algorithm: Jellyfish Optimizer Pseudo Code}, arc=.35mm, coltitle=black]
...
combinations of the data shape, dimensions and PP indexes considered are
provided in Table~\ref{tbl-smoothness-squintability}. Again, JSO is run
50 times for each scenario to calculate the success rate for each
...
space is alredy relatively easy to navigate. While increasing both
