...
\begin{tcolorbox}[enhanced jigsaw, colbacktitle=quarto-callout-note-color!10!white, left=2mm, toptitle=1mm, colback=white, colframe=quarto-callout-note-color-frame, bottomrule=.15mm, leftrule=.75mm, title={Algorithm: Jellyfish Optimizer Pseudo Code}, breakable, opacityback=0, titlerule=0mm, bottomtitle=1mm, rightrule=.15mm, arc=.35mm, toprule=.15mm, opacitybacktitle=0.6, coltitle=black]
