...
\begin{tcolorbox}[enhanced jigsaw, bottomrule=.15mm, breakable, bottomtitle=1mm, colframe=quarto-callout-note-color-frame, titlerule=0mm, toprule=.15mm, left=2mm, opacitybacktitle=0.6, colbacktitle=quarto-callout-note-color!10!white, rightrule=.15mm, colback=white, leftrule=.75mm, toptitle=1mm, opacityback=0, title={Algorithm: Jellyfish Optimizer Pseudo Code}, arc=.35mm, coltitle=black]
