...
\begin{tcolorbox}[enhanced jigsaw, rightrule=.15mm, bottomtitle=1mm, colback=white, toprule=.15mm, left=2mm, opacityback=0, colframe=quarto-callout-note-color-frame, arc=.35mm, bottomrule=.15mm, leftrule=.75mm, colbacktitle=quarto-callout-note-color!10!white, breakable, coltitle=black, toptitle=1mm, titlerule=0mm, title={Algorithm: Jellyfish Optimizer Pseudo Code}, opacitybacktitle=0.6]
