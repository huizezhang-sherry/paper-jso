...
\begin{tcolorbox}[enhanced jigsaw, toptitle=1mm, titlerule=0mm, arc=.35mm, opacitybacktitle=0.6, colframe=quarto-callout-note-color-frame, bottomrule=.15mm, colbacktitle=quarto-callout-note-color!10!white, breakable, coltitle=black, bottomtitle=1mm, title={Algorithm: Jellyfish Optimizer Pseudo Code}, opacityback=0, rightrule=.15mm, colback=white, leftrule=.75mm, toprule=.15mm, left=2mm]
