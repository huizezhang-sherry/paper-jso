...
\begin{tcolorbox}[enhanced jigsaw, opacitybacktitle=0.6, title={Algorithm: Jellyfish Optimizer Pseudo Code}, colback=white, opacityback=0, left=2mm, toprule=.15mm, breakable, leftrule=.75mm, toptitle=1mm, bottomtitle=1mm, titlerule=0mm, coltitle=black, arc=.35mm, colframe=quarto-callout-note-color-frame, rightrule=.15mm, colbacktitle=quarto-callout-note-color!10!white, bottomrule=.15mm]
