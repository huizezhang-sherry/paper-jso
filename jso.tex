...
\begin{tcolorbox}[enhanced jigsaw, colback=white, breakable, rightrule=.15mm, leftrule=.75mm, arc=.35mm, titlerule=0mm, opacitybacktitle=0.6, colbacktitle=quarto-callout-note-color!10!white, bottomtitle=1mm, title={Algorithm: Jellyfish Optimizer Pseudo Code}, opacityback=0, coltitle=black, colframe=quarto-callout-note-color-frame, toptitle=1mm, bottomrule=.15mm, toprule=.15mm, left=2mm]
