...
\begin{tcolorbox}[enhanced jigsaw, colbacktitle=quarto-callout-note-color!10!white, coltitle=black, opacitybacktitle=0.6, colback=white, left=2mm, toprule=.15mm, bottomrule=.15mm, opacityback=0, toptitle=1mm, bottomtitle=1mm, colframe=quarto-callout-note-color-frame, rightrule=.15mm, titlerule=0mm, arc=.35mm, title={Algorithm: Jellyfish Optimizer Pseudo Code}, breakable, leftrule=.75mm]
