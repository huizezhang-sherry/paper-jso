...
\begin{tcolorbox}[enhanced jigsaw, colframe=quarto-callout-note-color-frame, colback=white, rightrule=.15mm, opacitybacktitle=0.6, leftrule=.75mm, coltitle=black, breakable, title={Algorithm: Jellyfish Optimizer Pseudo Code}, colbacktitle=quarto-callout-note-color!10!white, toptitle=1mm, opacityback=0, left=2mm, bottomtitle=1mm, titlerule=0mm, arc=.35mm, toprule=.15mm, bottomrule=.15mm]
