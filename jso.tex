...
\begin{tcolorbox}[enhanced jigsaw, opacitybacktitle=0.6, bottomtitle=1mm, coltitle=black, title={Algorithm: Jellyfish Optimizer Pseudo Code}, colback=white, breakable, toptitle=1mm, colframe=quarto-callout-note-color-frame, leftrule=.75mm, left=2mm, bottomrule=.15mm, rightrule=.15mm, toprule=.15mm, colbacktitle=quarto-callout-note-color!10!white, arc=.35mm, titlerule=0mm, opacityback=0]
