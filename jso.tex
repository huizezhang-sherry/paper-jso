...
\begin{tcolorbox}[enhanced jigsaw, coltitle=black, titlerule=0mm, opacitybacktitle=0.6, left=2mm, toprule=.15mm, colback=white, leftrule=.75mm, arc=.35mm, colframe=quarto-callout-note-color-frame, toptitle=1mm, breakable, title={Algorithm: Jellyfish Optimizer Pseudo Code}, bottomtitle=1mm, rightrule=.15mm, bottomrule=.15mm, colbacktitle=quarto-callout-note-color!10!white, opacityback=0]
