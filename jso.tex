...
\begin{tcolorbox}[enhanced jigsaw, left=2mm, colback=white, opacityback=0, coltitle=black, title={Algorithm: Jellyfish Optimizer Pseudo Code}, leftrule=.75mm, breakable, arc=.35mm, colbacktitle=quarto-callout-note-color!10!white, toptitle=1mm, opacitybacktitle=0.6, colframe=quarto-callout-note-color-frame, bottomtitle=1mm, bottomrule=.15mm, toprule=.15mm, rightrule=.15mm, titlerule=0mm]
