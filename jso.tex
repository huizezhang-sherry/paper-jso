...
\begin{tcolorbox}[enhanced jigsaw, opacitybacktitle=0.6, rightrule=.15mm, colback=white, toptitle=1mm, opacityback=0, arc=.35mm, left=2mm, colframe=quarto-callout-note-color-frame, titlerule=0mm, bottomrule=.15mm, coltitle=black, bottomtitle=1mm, title={Algorithm: Jellyfish Optimizer Pseudo Code}, leftrule=.75mm, toprule=.15mm, breakable, colbacktitle=quarto-callout-note-color!10!white]
