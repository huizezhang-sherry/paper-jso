...
\begin{tcolorbox}[enhanced jigsaw, arc=.35mm, colframe=quarto-callout-note-color-frame, toprule=.15mm, title={Algorithm: Jellyfish Optimizer Pseudo Code}, titlerule=0mm, toptitle=1mm, bottomtitle=1mm, coltitle=black, opacityback=0, left=2mm, bottomrule=.15mm, leftrule=.75mm, rightrule=.15mm, opacitybacktitle=0.6, breakable, colback=white, colbacktitle=quarto-callout-note-color!10!white]
