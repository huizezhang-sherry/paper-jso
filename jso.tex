...
\begin{tcolorbox}[enhanced jigsaw, bottomtitle=1mm, colbacktitle=quarto-callout-note-color!10!white, opacityback=0, toprule=.15mm, coltitle=black, rightrule=.15mm, colback=white, toptitle=1mm, colframe=quarto-callout-note-color-frame, bottomrule=.15mm, left=2mm, title={Algorithm: Jellyfish Optimizer Pseudo Code}, arc=.35mm, leftrule=.75mm, breakable, opacitybacktitle=0.6, titlerule=0mm]
