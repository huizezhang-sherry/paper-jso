...
\begin{tcolorbox}[enhanced jigsaw, opacitybacktitle=0.6, colback=white, arc=.35mm, coltitle=black, leftrule=.75mm, opacityback=0, colframe=quarto-callout-note-color-frame, breakable, toptitle=1mm, bottomtitle=1mm, colbacktitle=quarto-callout-note-color!10!white, toprule=.15mm, title={Algorithm: Jellyfish Optimizer Pseudo Code}, titlerule=0mm, left=2mm, bottomrule=.15mm, rightrule=.15mm]
