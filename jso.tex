...
\begin{tcolorbox}[enhanced jigsaw, colbacktitle=quarto-callout-note-color!10!white, coltitle=black, leftrule=.75mm, rightrule=.15mm, bottomrule=.15mm, bottomtitle=1mm, toptitle=1mm, title={Algorithm: Jellyfish Optimizer Pseudo Code}, opacitybacktitle=0.6, breakable, arc=.35mm, titlerule=0mm, toprule=.15mm, opacityback=0, left=2mm, colframe=quarto-callout-note-color-frame, colback=white]
