...
\begin{tcolorbox}[enhanced jigsaw, breakable, left=2mm, colframe=quarto-callout-note-color-frame, titlerule=0mm, opacityback=0, bottomrule=.15mm, opacitybacktitle=0.6, rightrule=.15mm, colback=white, leftrule=.75mm, bottomtitle=1mm, toptitle=1mm, title={Algorithm: Jellyfish Optimizer Pseudo Code}, arc=.35mm, toprule=.15mm, colbacktitle=quarto-callout-note-color!10!white, coltitle=black]
