...
\begin{tcolorbox}[enhanced jigsaw, colbacktitle=quarto-callout-note-color!10!white, arc=.35mm, breakable, coltitle=black, title={Algorithm: Jellyfish Optimizer Pseudo Code}, colframe=quarto-callout-note-color-frame, bottomrule=.15mm, left=2mm, colback=white, bottomtitle=1mm, opacityback=0, toprule=.15mm, toptitle=1mm, titlerule=0mm, rightrule=.15mm, leftrule=.75mm, opacitybacktitle=0.6]
...
or change the interpretation above.

This results support the use of the proposed measures to effectively
capture key factors affecting the success rate of PP.
