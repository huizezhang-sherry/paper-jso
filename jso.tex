...
\begin{tcolorbox}[enhanced jigsaw, colbacktitle=quarto-callout-note-color!10!white, breakable, colframe=quarto-callout-note-color-frame, toptitle=1mm, titlerule=0mm, opacitybacktitle=0.6, leftrule=.75mm, toprule=.15mm, colback=white, bottomrule=.15mm, bottomtitle=1mm, coltitle=black, opacityback=0, title={Algorithm: Jellyfish Optimizer Pseudo Code}, rightrule=.15mm, arc=.35mm, left=2mm]
