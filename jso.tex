...
\begin{tcolorbox}[enhanced jigsaw, rightrule=.15mm, toprule=.15mm, breakable, colbacktitle=quarto-callout-note-color!10!white, titlerule=0mm, colframe=quarto-callout-note-color-frame, left=2mm, bottomtitle=1mm, bottomrule=.15mm, toptitle=1mm, opacityback=0, colback=white, title={Algorithm: Jellyfish Optimizer Pseudo Code}, opacitybacktitle=0.6, leftrule=.75mm, arc=.35mm, coltitle=black]
...
for interpretation, 2) re-coding the success rate for the
...
Squintability & 1.24 (1.05 to 1.58) & \textbf{0.033} \\ 
Dimension & 0.57 (0.33 to 0.87) & \textbf{0.022} \\ 
Number of jellyfish & 1.32 (1.06 to 1.71) & \textbf{0.022} \\ 
...
\caption{\label{tbl-joint-output}Fit statistics for models: full,
individual squintability and smoothness. The full model (and the model
containing squintability but not smoothness) explains more than 50\% of
the variability in optimisation success.}

\tabularnewline

\\
\toprule
\textbf{Model} & \textbf{Deviance} & \textbf{DF Residual} & \textbf{Null Deviance} & \textbf{DF Null}\\
\midrule
Full & 20.69 & 70 & 49.29 & 75\\
Interaction & 18.00 & 71 & 49.29 & 75\\
\bottomrule
