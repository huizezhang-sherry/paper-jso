...
#| fig-height: 6
#| out-width: 80%
#| fig-cap: "Examples of PP indexes with large (top row) and small (bottom row) squint angles, shown with a Huber plot, and histogram of the projected data corresponding to the optimal projection. Huber plot shows PP index values for all 1D projections in polar coordinates."
data(randu)
...
optimisation performance. @sec-sim-res presents the results. @sec-discussion discusses implementation details and insights for practitioners. 
