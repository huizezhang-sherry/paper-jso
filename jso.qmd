...
greater than 20 seconds is labelled 1. The fit suggests that the JSO success
...
for more tries also does not affect success rate significantly. An increase in
squintability of 10\% increases the success rate by
`r round(exp(broom::tidy(mod1)$estimate[3]) * 10, 0)`%. As dimension
