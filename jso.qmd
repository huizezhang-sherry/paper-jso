...
largest gradient of $-g$ and $\arg \min_{d} g'(d)$ represents the projection distance at which this largest gradient is attained.
...
values of $g'$ (the ones for which $g''=0$, assuming that $g$ is twice
