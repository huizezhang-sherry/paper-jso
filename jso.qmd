...
`r nrow(filter(sim_df, index != "holes"))` on the sine-wave data. A list of combinations of the data shape, dimensions and PP indexes considered are provided in @tbl-smoothness-squintability. Again, JSO is run 50 times for each scenario to calculate the success rate for each hyper-parameter combination.
