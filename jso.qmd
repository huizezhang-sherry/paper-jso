...
dimension, and smoothness and data dimension, improves the model slightly, but not enough to be practically important or change the interpretation above. 

This results support the use of the proposed
