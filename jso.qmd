...
the optimizer needs to be very close to be able to "see" the optimum, making it difficult for the optimizer to find the optimum. 
...
amenable to efficient optimization. This observation, shown in the simulated trace from different index functions in @fig-squintability-ill, suggests that the half-point index value improvement percentage provides an appropriate
