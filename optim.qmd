...
the success rate of JSO is positively associated with the two jellyfish
...
reduce the success rate. The variable `squintability` and `dimension`
are significant, suggesting their importance relative to jellyfish
