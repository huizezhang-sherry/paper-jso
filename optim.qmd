...
@grochowski2011) and extending it's use to visually explore
...
tour, and revealed a need to for improved optimisation. While improving
...
hyper-parameter choices (number of jellies and maximum number of tries).
...
comparing JSO's permformance improvements relative to an existing
...
execution of the optimisation, we choose to focus here on the first two
...
jellies, maximum tries) and data dimension combinations. A second
...
In this simulation, 50 jellies (`n_jellies`) and a maximum of 50 tries
...
rate: number of jellies (20, 50, and 100), and maximum number of tries
...
jellies. The tools for this are available in the `tourr` package, too.
