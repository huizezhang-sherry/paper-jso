...
\textcolor{blue}{In Section 7.1 some more details of using the planned tour with the jellyfish optimiser are given. More details on this are provided on the tourr package website, so that it can be kept updated if there are changes in the package.}
