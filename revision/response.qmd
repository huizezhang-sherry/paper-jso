...
**\textcolor{blue}{We have revised the text to include a comment on the correlation and why CRS cannot be run for the sine-wave optimization.  (TODO: Di - do you mind checking if we need more here?)}**
