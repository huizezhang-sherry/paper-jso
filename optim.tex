...
to hyper-parameter choices. The relationship between the JSO
performance, hyper-parameter tuning and properties of PP indexes is
analysed to provide guidance for practitioners using projection pursuit,
and developers of new indexes.
...
\begin{tcolorbox}[enhanced jigsaw, left=2mm, colback=white, opacityback=0, leftrule=.75mm, bottomtitle=1mm, arc=.35mm, colbacktitle=quarto-callout-note-color!10!white, title={Algorithm: Jellyfish Optimizer Pseudo Code}, toptitle=1mm, colframe=quarto-callout-note-color-frame, rightrule=.15mm, coltitle=black, breakable, bottomrule=.15mm, titlerule=0mm, toprule=.15mm, opacitybacktitle=0.6]
