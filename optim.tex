...
\begin{tcolorbox}[enhanced jigsaw, title={Algorithm: Jellyfish Optimizer Pseudo Code}, arc=.35mm, left=2mm, breakable, toprule=.15mm, colframe=quarto-callout-note-color-frame, opacityback=0, titlerule=0mm, bottomtitle=1mm, colback=white, toptitle=1mm, rightrule=.15mm, bottomrule=.15mm, leftrule=.75mm, colbacktitle=quarto-callout-note-color!10!white, opacitybacktitle=0.6, coltitle=black]
