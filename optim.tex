...
\begin{tcolorbox}[enhanced jigsaw, bottomtitle=1mm, colbacktitle=quarto-callout-note-color!10!white, toprule=.15mm, toptitle=1mm, bottomrule=.15mm, breakable, colback=white, colframe=quarto-callout-note-color-frame, leftrule=.75mm, coltitle=black, opacitybacktitle=0.6, title={Algorithm: Jellyfish Optimizer Pseudo Code}, arc=.35mm, titlerule=0mm, left=2mm, opacityback=0, rightrule=.15mm]
