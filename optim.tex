...
\begin{tcolorbox}[enhanced jigsaw, coltitle=black, colbacktitle=quarto-callout-note-color!10!white, rightrule=.15mm, leftrule=.75mm, arc=.35mm, left=2mm, opacityback=0, breakable, toptitle=1mm, toprule=.15mm, title={Algorithm: Jellyfish Optimizer Pseudo Code}, bottomtitle=1mm, colback=white, titlerule=0mm, bottomrule=.15mm, opacitybacktitle=0.6, colframe=quarto-callout-note-color-frame]
