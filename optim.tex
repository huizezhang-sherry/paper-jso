...
\begin{tcolorbox}[enhanced jigsaw, opacitybacktitle=0.6, left=2mm, title={Algorithm: Jellyfish Optimizer Pseudo Code}, toprule=.15mm, toptitle=1mm, colback=white, colframe=quarto-callout-note-color-frame, titlerule=0mm, breakable, coltitle=black, colbacktitle=quarto-callout-note-color!10!white, bottomtitle=1mm, bottomrule=.15mm, arc=.35mm, rightrule=.15mm, leftrule=.75mm, opacityback=0]
