...
\begin{tcolorbox}[enhanced jigsaw, bottomtitle=1mm, colbacktitle=quarto-callout-note-color!10!white, breakable, left=2mm, title={Algorithm: Jellyfish Optimizer Pseudo Code}, arc=.35mm, coltitle=black, toptitle=1mm, opacitybacktitle=0.6, colframe=quarto-callout-note-color-frame, leftrule=.75mm, opacityback=0, colback=white, toprule=.15mm, bottomrule=.15mm, rightrule=.15mm, titlerule=0mm]
