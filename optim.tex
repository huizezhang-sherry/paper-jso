...
\begin{tcolorbox}[enhanced jigsaw, left=2mm, coltitle=black, opacitybacktitle=0.6, colback=white, breakable, leftrule=.75mm, colbacktitle=quarto-callout-note-color!10!white, arc=.35mm, toptitle=1mm, bottomtitle=1mm, toprule=.15mm, colframe=quarto-callout-note-color-frame, titlerule=0mm, title={Algorithm: Jellyfish Optimizer Pseudo Code}, bottomrule=.15mm, rightrule=.15mm, opacityback=0]
