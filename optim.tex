...
\begin{tcolorbox}[enhanced jigsaw, opacitybacktitle=0.6, colbacktitle=quarto-callout-note-color!10!white, breakable, opacityback=0, toptitle=1mm, leftrule=.75mm, titlerule=0mm, coltitle=black, colframe=quarto-callout-note-color-frame, bottomrule=.15mm, rightrule=.15mm, arc=.35mm, toprule=.15mm, colback=white, bottomtitle=1mm, title={Algorithm: Jellyfish Optimizer Pseudo Code}, left=2mm]
