...
\begin{tcolorbox}[enhanced jigsaw, rightrule=.15mm, coltitle=black, toptitle=1mm, title={Algorithm: Jellyfish Optimizer Pseudo Code}, left=2mm, opacitybacktitle=0.6, colframe=quarto-callout-note-color-frame, arc=.35mm, opacityback=0, breakable, colbacktitle=quarto-callout-note-color!10!white, bottomrule=.15mm, bottomtitle=1mm, titlerule=0mm, toprule=.15mm, leftrule=.75mm, colback=white]
