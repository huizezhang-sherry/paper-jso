...
to be integrated with projection pursuit guided tour. JSO
...
\begin{tcolorbox}[enhanced jigsaw, opacityback=0, opacitybacktitle=0.6, title={Algorithm: Jellyfish Optimizer Pseudo Code}, leftrule=.75mm, coltitle=black, titlerule=0mm, breakable, arc=.35mm, toprule=.15mm, left=2mm, bottomrule=.15mm, bottomtitle=1mm, colframe=quarto-callout-note-color-frame, colbacktitle=quarto-callout-note-color!10!white, colback=white, toptitle=1mm, rightrule=.15mm]
