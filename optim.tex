...
\begin{tcolorbox}[enhanced jigsaw, opacityback=0, coltitle=black, colframe=quarto-callout-note-color-frame, arc=.35mm, colbacktitle=quarto-callout-note-color!10!white, breakable, bottomtitle=1mm, leftrule=.75mm, title={Algorithm: Jellyfish Optimizer Pseudo Code}, rightrule=.15mm, toptitle=1mm, opacitybacktitle=0.6, bottomrule=.15mm, left=2mm, colback=white, titlerule=0mm, toprule=.15mm]
