...
\begin{tcolorbox}[enhanced jigsaw, bottomtitle=1mm, toprule=.15mm, bottomrule=.15mm, colframe=quarto-callout-note-color-frame, toptitle=1mm, colbacktitle=quarto-callout-note-color!10!white, titlerule=0mm, rightrule=.15mm, opacityback=0, title={Algorithm: Jellyfish Optimizer Pseudo Code}, arc=.35mm, leftrule=.75mm, left=2mm, breakable, opacitybacktitle=0.6, coltitle=black, colback=white]
