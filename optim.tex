...
\begin{tcolorbox}[enhanced jigsaw, opacityback=0, breakable, colbacktitle=quarto-callout-note-color!10!white, titlerule=0mm, arc=.35mm, colframe=quarto-callout-note-color-frame, bottomrule=.15mm, coltitle=black, toptitle=1mm, toprule=.15mm, leftrule=.75mm, left=2mm, colback=white, opacitybacktitle=0.6, title={Algorithm: Jellyfish Optimizer Pseudo Code}, bottomtitle=1mm, rightrule=.15mm]
