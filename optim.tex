...
\begin{tcolorbox}[enhanced jigsaw, leftrule=.75mm, titlerule=0mm, colbacktitle=quarto-callout-note-color!10!white, coltitle=black, arc=.35mm, breakable, toptitle=1mm, title={Algorithm: Jellyfish Optimizer Pseudo Code}, bottomrule=.15mm, colback=white, opacityback=0, left=2mm, toprule=.15mm, opacitybacktitle=0.6, bottomtitle=1mm, colframe=quarto-callout-note-color-frame, rightrule=.15mm]
