...
\begin{tcolorbox}[enhanced jigsaw, colback=white, arc=.35mm, leftrule=.75mm, opacitybacktitle=0.6, colframe=quarto-callout-note-color-frame, title={Algorithm: Jellyfish Optimizer Pseudo Code}, colbacktitle=quarto-callout-note-color!10!white, bottomtitle=1mm, toptitle=1mm, opacityback=0, bottomrule=.15mm, titlerule=0mm, coltitle=black, rightrule=.15mm, breakable, toprule=.15mm, left=2mm]
