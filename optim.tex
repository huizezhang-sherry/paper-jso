...
\begin{tcolorbox}[enhanced jigsaw, colback=white, opacitybacktitle=0.6, left=2mm, toprule=.15mm, colbacktitle=quarto-callout-note-color!10!white, coltitle=black, titlerule=0mm, bottomtitle=1mm, bottomrule=.15mm, title={Algorithm: Jellyfish Optimizer Pseudo Code}, opacityback=0, arc=.35mm, breakable, rightrule=.15mm, toptitle=1mm, colframe=quarto-callout-note-color-frame, leftrule=.75mm]
