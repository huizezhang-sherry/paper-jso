...
\begin{tcolorbox}[enhanced jigsaw, bottomrule=.15mm, toptitle=1mm, left=2mm, opacitybacktitle=0.6, colbacktitle=quarto-callout-note-color!10!white, bottomtitle=1mm, titlerule=0mm, toprule=.15mm, opacityback=0, colframe=quarto-callout-note-color-frame, title={Algorithm: Jellyfish Optimizer Pseudo Code}, colback=white, breakable, arc=.35mm, rightrule=.15mm, leftrule=.75mm, coltitle=black]
