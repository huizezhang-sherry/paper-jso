...
\begin{tcolorbox}[enhanced jigsaw, arc=.35mm, colback=white, toptitle=1mm, opacityback=0, colbacktitle=quarto-callout-note-color!10!white, breakable, bottomtitle=1mm, coltitle=black, title={Algorithm: Jellyfish Optimizer Pseudo Code}, titlerule=0mm, rightrule=.15mm, colframe=quarto-callout-note-color-frame, bottomrule=.15mm, opacitybacktitle=0.6, toprule=.15mm, leftrule=.75mm, left=2mm]
