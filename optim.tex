...
\begin{tcolorbox}[enhanced jigsaw, colframe=quarto-callout-note-color-frame, coltitle=black, colback=white, colbacktitle=quarto-callout-note-color!10!white, left=2mm, leftrule=.75mm, titlerule=0mm, rightrule=.15mm, toptitle=1mm, opacityback=0, arc=.35mm, bottomrule=.15mm, bottomtitle=1mm, title={Algorithm: Jellyfish Optimizer Pseudo Code}, toprule=.15mm, opacitybacktitle=0.6, breakable]
