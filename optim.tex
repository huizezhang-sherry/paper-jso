...
\begin{tcolorbox}[enhanced jigsaw, colback=white, title={Algorithm: Jellyfish Optimizer Pseudo Code}, leftrule=.75mm, breakable, titlerule=0mm, opacityback=0, bottomtitle=1mm, colframe=quarto-callout-note-color-frame, arc=.35mm, toprule=.15mm, opacitybacktitle=0.6, toptitle=1mm, colbacktitle=quarto-callout-note-color!10!white, rightrule=.15mm, bottomrule=.15mm, left=2mm, coltitle=black]
