...
\begin{tcolorbox}[enhanced jigsaw, colframe=quarto-callout-note-color-frame, rightrule=.15mm, breakable, opacityback=0, toptitle=1mm, colbacktitle=quarto-callout-note-color!10!white, colback=white, bottomrule=.15mm, arc=.35mm, toprule=.15mm, bottomtitle=1mm, titlerule=0mm, opacitybacktitle=0.6, coltitle=black, title={Algorithm: Jellyfish Optimizer Pseudo Code}, leftrule=.75mm, left=2mm]
...
jellyfish. The tools for this are available in the \texttt{tourr}
package, too.
