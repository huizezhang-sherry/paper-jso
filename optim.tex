...
\begin{tcolorbox}[enhanced jigsaw, coltitle=black, toprule=.15mm, colback=white, breakable, colbacktitle=quarto-callout-note-color!10!white, bottomrule=.15mm, arc=.35mm, leftrule=.75mm, opacityback=0, colframe=quarto-callout-note-color-frame, bottomtitle=1mm, toptitle=1mm, titlerule=0mm, left=2mm, title={Algorithm: Jellyfish Optimizer Pseudo Code}, rightrule=.15mm, opacitybacktitle=0.6]
...
In this simulation, 50 jellies (\texttt{n\_jellies}) and a maximum of 50
tries (\texttt{max\_tries}) are used. The full data contains 50
...
(50 and 100). Figure~\ref{fig-success-rate} illustrates the calculation
based on the projection found by the above simulation. Here, the optimal
index value is 0.999. Out of the 50 simulations, 44 achieved an index
value within {[}0.949, 0.999{]}, resulting in a success rate of 0.88.
