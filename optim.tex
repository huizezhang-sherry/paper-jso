...
\begin{tcolorbox}[enhanced jigsaw, leftrule=.75mm, colframe=quarto-callout-note-color-frame, toptitle=1mm, title={Algorithm: Jellyfish Optimizer Pseudo Code}, titlerule=0mm, opacityback=0, breakable, toprule=.15mm, arc=.35mm, colback=white, coltitle=black, bottomrule=.15mm, bottomtitle=1mm, colbacktitle=quarto-callout-note-color!10!white, left=2mm, rightrule=.15mm, opacitybacktitle=0.6]
