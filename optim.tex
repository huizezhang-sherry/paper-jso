...
\begin{tcolorbox}[enhanced jigsaw, toptitle=1mm, bottomtitle=1mm, bottomrule=.15mm, rightrule=.15mm, colbacktitle=quarto-callout-note-color!10!white, titlerule=0mm, leftrule=.75mm, coltitle=black, opacitybacktitle=0.6, title={Algorithm: Jellyfish Optimizer Pseudo Code}, breakable, opacityback=0, colback=white, left=2mm, toprule=.15mm, arc=.35mm, colframe=quarto-callout-note-color-frame]
