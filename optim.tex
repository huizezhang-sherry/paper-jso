...
\begin{tcolorbox}[enhanced jigsaw, arc=.35mm, coltitle=black, colframe=quarto-callout-note-color-frame, opacityback=0, toprule=.15mm, opacitybacktitle=0.6, colback=white, bottomrule=.15mm, leftrule=.75mm, titlerule=0mm, toptitle=1mm, title={Algorithm: Jellyfish Optimizer Pseudo Code}, bottomtitle=1mm, rightrule=.15mm, breakable, colbacktitle=quarto-callout-note-color!10!white, left=2mm]
