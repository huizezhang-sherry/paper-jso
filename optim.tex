...
\begin{tcolorbox}[enhanced jigsaw, opacityback=0, opacitybacktitle=0.6, colframe=quarto-callout-note-color-frame, titlerule=0mm, bottomrule=.15mm, toprule=.15mm, leftrule=.75mm, bottomtitle=1mm, breakable, toptitle=1mm, arc=.35mm, colback=white, rightrule=.15mm, title={Algorithm: Jellyfish Optimizer Pseudo Code}, left=2mm, coltitle=black, colbacktitle=quarto-callout-note-color!10!white]
