...
\begin{tcolorbox}[enhanced jigsaw, coltitle=black, titlerule=0mm, opacitybacktitle=0.6, leftrule=.75mm, left=2mm, bottomtitle=1mm, bottomrule=.15mm, toprule=.15mm, colframe=quarto-callout-note-color-frame, breakable, colbacktitle=quarto-callout-note-color!10!white, colback=white, rightrule=.15mm, opacityback=0, toptitle=1mm, title={Algorithm: Jellyfish Optimizer Pseudo Code}, arc=.35mm]
