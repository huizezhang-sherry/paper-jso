...
\begin{tcolorbox}[enhanced jigsaw, toprule=.15mm, coltitle=black, rightrule=.15mm, titlerule=0mm, title={Algorithm: Jellyfish Optimizer Pseudo Code}, bottomrule=.15mm, left=2mm, breakable, colbacktitle=quarto-callout-note-color!10!white, colback=white, toptitle=1mm, opacityback=0, opacitybacktitle=0.6, arc=.35mm, bottomtitle=1mm, leftrule=.75mm, colframe=quarto-callout-note-color-frame]
...
appendex, since it is not full grid simulation (otherwise for the
...
to jellyfish hyper-parameters in the optimisation sucess.
...
squintability, number of jellyfish and maximum numer of tries are
...
with teh success rate. The variable squintability and dimension are
