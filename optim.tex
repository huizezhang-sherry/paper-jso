...
\begin{tcolorbox}[enhanced jigsaw, leftrule=.75mm, rightrule=.15mm, bottomrule=.15mm, colback=white, bottomtitle=1mm, arc=.35mm, opacityback=0, opacitybacktitle=0.6, toprule=.15mm, colbacktitle=quarto-callout-note-color!10!white, left=2mm, breakable, coltitle=black, toptitle=1mm, titlerule=0mm, colframe=quarto-callout-note-color-frame, title={Algorithm: Jellyfish Optimizer Pseudo Code}]
