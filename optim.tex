...
\begin{tcolorbox}[enhanced jigsaw, left=2mm, opacityback=0, toprule=.15mm, opacitybacktitle=0.6, coltitle=black, breakable, colframe=quarto-callout-note-color-frame, colback=white, arc=.35mm, bottomtitle=1mm, title={Algorithm: Jellyfish Optimizer Pseudo Code}, toptitle=1mm, titlerule=0mm, rightrule=.15mm, leftrule=.75mm, bottomrule=.15mm, colbacktitle=quarto-callout-note-color!10!white]
